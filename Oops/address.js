...
var addressss = /** @class */ (function () {
    function addressss(firstname, lastname, idno, state, city, zip, phno) {
    ...
    try {
        ...
        switch (choice) {
            case 1:
                ...
                break;
            case 2:
                var idno = parseInt(read.question("enter your id number"));
                updateAddress(idno);
                break;
            case 3:
                deletee();
...
function readfile() {
    var data = filestream.readFileSync('/home/admin1/Desktop/TypeScripttt/adrressBook.json');
...
function writefile(data) {
    ...
    filestream.writeFileSync('/home/admin1/Desktop/TypeScripttt/adrressBook.json', data1);
}
//update method is used to update the address of particular person in the address book
function updateAddress(idno) {
    try {
        var data = readfile();
